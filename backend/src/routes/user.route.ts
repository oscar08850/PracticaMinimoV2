...
import grupoinvestigacionController from '../controllers/user.controller'
...
router.get('/:id', grupoinvestigacionController.getUser);
router.post('/new',grupoinvestigacionController.newUser);
